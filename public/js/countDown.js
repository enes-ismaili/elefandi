            ...
            get: function() {
                ...
                value: function(t) {
                    var e, n = this,
                        ...
                        intervalContClassName, showDay;
                    for (e in t)
                        if (t.hasOwnProperty(e)) {
                            intervalContClassName = this._getIntervalContClassName(e);
                            var o = '<div class="'.concat(this.elementClassPrefix, 'interval_basic_cont">\n                                       <div class="').concat(this._getIntervalContCommonClassName(), " ").concat(intervalContClassName, '">'),
                                a = '<div class="'.concat(this.elementClassPrefix, 'interval_basic_cont_description">\n                                                   ').concat(this.options.outputTranslation[e], "\n                                               </div>");
                            t[e].forEach(function(t, e) {
                                showDay = '';
                                if (intervalContClassName == 'countDown__interval_cont_day' && t == 0) { showDay = ' empty' }
                                o += '<div class="'.concat(n._getDigitContCommonClassName(), " ").concat(n._getDigitContClassName(e).concat(showDay), '">\n                                        ').concat(n._getDigitElementString(t, 0), "\n                                    </div>")
                            }), i += o + "</div>" + a + "</div>"
                        }
