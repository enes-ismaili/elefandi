...
var sidebarButton = document.querySelectorAll('.accordion-toggle');
sidebarButton.forEach(function (button) {
  button.addEventListener('click', function (e) {
    e.preventDefault();
    var thisButton = e.target.getAttribute("aria-expanded");
...
var transportiInput = document.querySelectorAll('.transporti input[type="checkbox"]');
transportiInput.forEach(function (transport) {
  transport.addEventListener('change', function (e) {
    var thisInput = e.target;
    var transChecked = thisInput.checked;
    var transVal = thisInput.value;
    var transportParent = thisInput.parentElement.parentElement;
    var transId = transportParent.id;
...
;
var workHoursInputs = document.querySelectorAll('.workhours input[type="checkbox"]');
workHoursInputs.forEach(function (workHours) {
  var thisElem = workHours.parentElement.parentElement.parentElement.parentElement;
  ...
  workHours.addEventListener('change', function (e) {
    var thisInput = e.target.parentElement.parentElement.parentElement.parentElement;
...
var timeInputs = document.querySelectorAll('.inputtimes');
timeInputs.forEach(function (minIput) {
  minIput.addEventListener('change', function (e) {
    var thisInput = e.target;
    var parentInput = thisInput.parentElement;
    var minELem = parentInput.querySelector('.input-hmin').value;
    ...
    var maxELem = parentInput.querySelector('.input-hmax').value;
...
var closeModals = document.querySelectorAll('.closeModal'); // deleteButtons.forEach(deleteButton => {
...
window.deleteModalF = function (e) {
  deleteModal.classList.add('show');
  deleteModal.querySelectorAll('.modalType').forEach(function (modaltype) {
...
var openMenu = document.querySelector('.header .menu-toggle-button .nav-link');
