    ...
    @push('scripts')
        ...
        <script>
            ...
            function delete_variant(e){
                ...
                let variantId = thisRow.querySelector('.svariant_id');
                thisRow.remove();
            }
...
.shipping-product.show {
    ...
    <x-slot name="breadcrumb">
        ...
        <ul class="links">
            ...
            <li>
                <a href="{{route('vendor.products.index')}}">Ndrysho Produkt</a>
            </li>
        </ul>
    </x-slot>
    <form action="{{route('vendor.products.store', ['id' => $product->id])}}" method="POST">
        @csrf
        <div class="row">
            <div class="col-xl-8">
                <div class="card">
                            ...
                            <table class="table table-bordered aiz-table footable footable-8 breakpoint-xl">
                                <thead>
                                    <tr class="footable-header">
                                        <td class="text-center footable-first-visible" >Varianti</td>
                                        <td class="text-center" >Çmimi i Variantit</td>
                                        <td class="text-center">SKU</td>
                                        <td class="text-center">Stoku</td>
                                        <td class="text-center table-variant_image" >Foto</td>
                                        <td class="footable-last-visible table-actions"></td>
                                    </tr>
                                </thead>
