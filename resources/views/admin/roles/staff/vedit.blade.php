...
.role-description .roles.active {
    ...
    @endpush
    <form action="{{route('vendor.staff.save', [$userRole->user_id, $userRole->role_id])}}" method="POST" class="">
        @csrf
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">Ndrysho Staf</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            @livewire('select-user', ['pid' => $userRole->user_id, 'edit'=>false])
