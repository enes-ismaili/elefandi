...
.administrator .hide-admin {
    ...
    @endpush
    <form action="{{route('admin.roles.add.save', $role->id)}}" method="POST" class="{{ ($role->type == 1) ? 'administrator' : ''}}">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">Ndrysho Rol</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <label for="name">Emri i Rolit *</label>
                            <input type="text" name="name" class="form-control" id="name" placeholder="Emri" value="{{ $role->name }}">
                            @error('name') <span class="text-danger error">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group">
                            <label for="productdesc">Përshkrimi i Rolit</label>
                            <textarea class="form-control" name="description" id="productdesc" rows="3" placeholder="Përshkrimi">{{ $role->description }}</textarea>
                        ...
                        @if($role->can_edit == 1)
                            <div class="form-group">
                                ...
                                <select id="selectAction" name="action">
                                    <option value="0" {{ ($role->type) ? '' : 'selected' }}>Dyqanet</option>
                                    <option value="1" {{ ($role->type) ? 'selected' : '' }}>Administratorët</option>
                                </select>
                            </div>
                        @endif
                    </div>
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @if($role->can_edit == 0)
                            <p class="small text-danger">Të drejtat e këtij roli nuk mund të ndryshohet</p>
                        @endif
                        <div class="row hide-vend">
                            ...
                            <div class="col-2 nospace">
                                <label class="cth-switch cth-switch-success mb-0">
                                    <input value="1" type="checkbox" name="manage_users" {{ ($role->manage_users) ? 'checked' : '' }} {{ ($role->can_edit == 0) ? 'disabled' : '' }}>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        <div class="row hide-vend">
                            ...
                            <div class="col-2 nospace">
                                <label class="cth-switch cth-switch-success mb-0">
                                    <input value="1" type="checkbox" name="manage_vendors" {{ ($role->manage_vendors) ? 'checked' : '' }} {{ ($role->can_edit == 0) ? 'disabled' : '' }}>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        <div class="row hide-vend mb-3">
                            ...
                            <div class="col-2 nospace">
                                <label class="cth-switch cth-switch-success mb-0">
                                    <input value="1" type="checkbox" name="manage_pages" {{ ($role->manage_vendor) ? 'checked' : '' }} {{ ($role->can_edit == 0) ? 'disabled' : '' }}>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        <div class="row hide-admin">
                            ...
                            <div class="col-2 nospace">
                                <label class="cth-switch cth-switch-success mb-0">
                                    <input value="1" type="checkbox" name="manage_vendor" {{ ($role->manage_vendor) ? 'checked' : '' }} {{ ($role->can_edit == 0) ? 'disabled' : '' }}>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-2 nospace">
                                <label class="cth-switch cth-switch-success mb-0">
                                    <input value="1" type="checkbox" name="manage_stories" {{ ($role->manage_stories) ? 'checked' : '' }} {{ ($role->can_edit == 0) ? 'disabled' : '' }}>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-2 nospace">
                                <label class="cth-switch cth-switch-success mb-0">
                                    <input value="1" type="checkbox" name="manage_ads" {{ ($role->manage_ads) ? 'checked' : '' }} {{ ($role->can_edit == 0) ? 'disabled' : '' }}>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        {{-- <div class="row">
                            ...
                            <div class="col-2 nospace">
                                <label class="cth-switch cth-switch-success mb-0">
                                    <input value="1" type="checkbox" name="manage_notifications" {{ ($role->manage_notifications) ? 'checked' : '' }} {{ ($role->can_edit == 0) ? 'disabled' : '' }}>
                                    <span></span>
                                </label>
                            </div>
                        </div> --}}
                        <div class="row hide-admin">
                            ...
                            <div class="col-2 nospace">
                                <label class="cth-switch cth-switch-success mb-0">
                                    <input value="1" type="checkbox" name="manage_chat" {{ ($role->manage_chat) ? 'checked' : '' }} {{ ($role->can_edit == 0) ? 'disabled' : '' }}>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-2 nospace">
                                <label class="cth-switch cth-switch-success mb-0">
                                    <input value="1" type="checkbox" name="manage_supports" {{ ($role->manage_supports) ? 'checked' : '' }} {{ ($role->can_edit == 0) ? 'disabled' : '' }}>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-2 nospace">
                                <label class="cth-switch cth-switch-success mb-0">
                                    <input value="1" type="checkbox" name="manage_offers" {{ ($role->manage_offers) ? 'checked' : '' }} {{ ($role->can_edit == 0) ? 'disabled' : '' }}>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-2 nospace">
                                <label class="cth-switch cth-switch-success mb-0">
                                    <input value="1" type="checkbox" name="manage_products" {{ ($role->manage_products) ? 'checked' : '' }} {{ ($role->can_edit == 0) ? 'disabled' : '' }}>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-2 nospace">
                                <label class="cth-switch cth-switch-success mb-0">
                                    <input value="1" type="checkbox" name="manage_orders" {{ ($role->manage_orders) ? 'checked' : '' }} {{ ($role->can_edit == 0) ? 'disabled' : '' }}>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-2 nospace">
                                <label class="cth-switch cth-switch-success mb-0">
                                    <input value="1" type="checkbox" name="delete_rights" {{ ($role->delete_rights) ? 'checked' : '' }} {{ ($role->can_edit == 0) ? 'disabled' : '' }}>
                                    <span></span>
                                </label>
                            </div>
                        </div>
