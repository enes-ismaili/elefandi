<x-admin-layout>
    ...
    @endpush
    <form action="{{route('admin.offers.save')}}" method="POST" class="search-product">
        @csrf
        @livewire('offer.create-offer', ['showForm' => true, 'selectedType'=> 4, 'offerTitle'=> 'Krijo Ofertë Speciale', 'editRole'=> 1, 'searchAll'=>true])
    </form>
</x-admin-layout>