<x-admin-layout>
    ...
    <div x-data="{ utype: {{ (old('storyType') ? old('storyType') : 1) }} }">
        <div class="product-area mt-2">
            <form action="{{ route('vendor.stories1.store') }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="duration" class="form-control" id="duration" placeholder="Kohezgjatja" value="{{ old('duration') ?? 10 }}" min="1" max="20">
