<x-admin-layout>
    ...
    <x-slot name="breadcrumb">
        ...
        <ul class="links">
            ...
            <li>
                <a href="{{route('admin.stories.index')}}">Story-it</a>
            </li>
        </ul>
    </x-slot>
    <div x-data="{ utype: {{ (old('storyType') ? old('storyType') : 1) }} }">
        <div class="product-area mt-2">
            <form action="{{ route('admin.stories.story.store', $stories->id) }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    <label for="name">Emri i butonit tek Linkut</label>
