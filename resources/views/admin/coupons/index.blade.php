                        ...
                        @foreach($coupons as $coupon)
                            ...
                            <tr class="{{ $isCouponOlder ? 'older' : '' }}">
                                ...
                                <td>
                                    @if($coupon->vendor_id)
                                        @php
                                            $currVendor = App\Models\Vendor::where('id', $coupon->vendor_id)->first();
                                        @endphp
                                        @if($currVendor)
                                        <a href="{{ route('single.vendor', $currVendor->slug) }}" class="table-block">{!! strtoupper($currVendor->name) !!}</a>
                                        @endif
                                    @endif
                                </td>
                                <td>{{ $couponType }}</td>
                                ...
                                <td class="action-icons">
                                    <a href="{{ route('admin.coupons.edit', $coupon->id) }}" class="action-icon" title="Ndrysho"><i class="fas fa-edit" aria-hidden="true"></i></a>
