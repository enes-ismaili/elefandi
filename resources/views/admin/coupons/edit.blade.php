...
.search-results ul li span + span {
    ...
    @endpush
    <form action="{{route('admin.coupons.store', ['id' => $coupon->id])}}" method="POST">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                  <span class="input-group-text" id="basic-addon1">v{{ $coupon->vendor_id }}-</span>
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="flatpickr date tomorrow" type=text placeholder="Data e Fillimit" name="expire_date" value="{{ ($coupon->expire_date) ? $coupon->expire_date : Carbon\Carbon::tomorrow() }}">
                        </div>
                    </div>
